...
(
    ...
    `type`        int(11)      DEFAULT 0 COMMENT '0:文章 1:视频',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='知识普及文章表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='疫情动态表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='论坛评论表';
